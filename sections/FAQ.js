  ...
  return (
    ...
    <Accordion type="single" collapsible className="w-[900px] mt-12 mx-auto">
      ...
      <AccordionItem value="item-2">
        <AccordionTrigger> Is the platform only for experienced developers?</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="item-3">
        <AccordionTrigger> What kind of assistance can I seek or offer?</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="item-4">
        <AccordionTrigger>  How are credits or experience points earned?</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="item-5">
        <AccordionTrigger>   How can I join and start using the platform?</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="item-6">
        <AccordionTrigger>   Is my information and data secure on the platform?</AccordionTrigger>
        <AccordionContent>
